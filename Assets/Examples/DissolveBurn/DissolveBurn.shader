...
Shader "Custom/DissolveBurn"
{
	Properties
	{
		...
		[ASEEnd]_DissolveSpeed("DissolveSpeed", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float mulTime35 = _TimeParameters.x * _DissolveSpeed;
				float AlphaOffset38 = (1.0 + (( mulTime35 % 2.0 ) - 0.0) * (-1.0 - 1.0) / (2.0 - 0.0));
				float4 clampResult33 = clamp( ( tex2D( _Noise, uv_Noise ) + AlphaOffset38 ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float4 appendResult26 = (float4((float4( -0.23,0,0,0 ) + (clampResult33 - float4( 0,0,0,0 )) * (float4( 0.32,1,1,1 ) - float4( -0.23,0,0,0 )) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )))));
				float4 tex2DNode16 = tex2D( _TextureSample0, appendResult26.xy );
				float4 appendResult28 = (float4(tex2DNode16.r , tex2DNode16.g , 0.0 , tex2DNode16.a));
				...
				float3 Emission = appendResult28.xyz;
				float3 Specular = tex2D( _Specular, uv_Specular ).rgb;
				float Metallic = 0;
				float Smoothness = _Smoothness;
				float Occlusion = 1;
				float Alpha = clampResult33.r;
...
/*ASEBEGIN
Version=18935
2242.4;73.6;1414;559.8;2723.175;427.1941;1.893639;True;False
Node;AmplifyShaderEditor.CommentaryNode;40;-3050.45,168.7914;Inherit;False;1119.335;247.063;common;5;38;37;36;35;41;Alpha值随时间的偏移;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;41;-3027.58,268.995;Inherit;False;Property;_DissolveSpeed;DissolveSpeed;7;0;Create;True;0;0;0;False;0;False;1;0.62;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;35;-2807.603,271.2541;Inherit;False;1;0;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleRemainderNode;36;-2578.824,273.4588;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;37;-2346.305,218.7914;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;2;False;3;FLOAT;1;False;4;FLOAT;-1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;38;-2139.267,233.2363;Inherit;False;AlphaOffset;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;39;-1626.049,219.3066;Inherit;False;38;AlphaOffset;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;14;-1697.606,-41.79918;Inherit;True;Property;_Noise;Noise;4;0;Create;True;0;0;0;False;0;False;-1;None;e24b2c680edaa90458d31f11544d79ca;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;34;-1234.635,162.8968;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;32;-1440.006,367.4831;Inherit;False;988.8048;280;随着Alpha改变纹理映射，并将渐变色域映射到红色和黄色;4;16;25;26;28;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;16;-984.2224,417.4834;Inherit;True;Property;_TextureSample0;Texture Sample 0;6;0;Create;True;0;0;0;False;0;False;-1;None;bb47b838a0905154496dfe9920ae73b0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;28;-612.0026,446.564;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-373.0715,509.7464;Inherit;False;Property;_AlphaClipThreshold;AlphaClipThreshold;5;0;Create;True;0;0;0;False;0;False;0.5;0.01;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;26;-1158.083,440.3417;Inherit;False;FLOAT4;4;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;11;-853.4791,-218.4926;Inherit;True;Property;_Normal;Normal;1;0;Create;True;0;0;0;False;0;False;-1;None;11f03d9db1a617e40b7ece71f0a84f6f;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-852.2598,-430.6036;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;7130c16fd8005b546b111d341310a9a4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-369.4438,406.1113;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-837.0992,-3.791999;Inherit;True;Property;_Specular;Specular;2;0;Create;True;0;0;0;False;0;False;-1;None;6618005f6bafebf40b3d09f498401fba;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;33;-1042.092,161.7481;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCRemapNode;25;-1390.006,438.1241;Inherit;False;5;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,1;False;3;COLOR;-0.23,0,0,0;False;4;COLOR;0.32,1,1,1;False;1;COLOR;0
...
WireConnection;28;1;16;2
WireConnection;28;3;16;4
...
ASEEND*/
//CHKSM=9809B5E9602611A38F4EDABF80324F26863905A7
...
Shader "Custom/BurningFire"
{
	Properties
	{
		...
		[ASEEnd]_FireSpeed("FireSpeed", Range( 1 , 25)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_WoodNormal = IN.ase_texcoord8.xy * _WoodNormal_ST.xy + _WoodNormal_ST.zw;
				
				float2 uv_Mask = IN.ase_texcoord8.xy * _Mask_ST.xy + _Mask_ST.zw;
				float2 texCoord20 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner19 = ( ( ( _TimeParameters.x * 0.05 ) * _FireSpeed ) * float2( 1,0 ) + texCoord20);
				
				float2 uv_WoodSpecular = IN.ase_texcoord8.xy * _WoodSpecular_ST.xy + _WoodSpecular_ST.zw;
				
				float3 Albedo = tex2D( _Albedo, uv_Albedo ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _WoodNormal, uv_WoodNormal ), 1.0f );
				float3 Emission = ( tex2D( _Mask, uv_Mask ) * tex2D( _TileableFire, panner19 ) * (0.5 + (_TimeParameters.y - -1.0) * (2.5 - 0.5) / (1.0 - -1.0)) * _FireIntensity ).rgb;
				float3 Specular = tex2D( _WoodSpecular, uv_WoodSpecular ).rgb;
				float Metallic = 0;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_WoodNormal = IN.ase_texcoord4.xy * _WoodNormal_ST.xy + _WoodNormal_ST.zw;
...
/*ASEBEGIN
Version=18935
2242.4;73.6;1414;559.8;2234.238;-105.6739;1.408508;True;False
Node;AmplifyShaderEditor.SamplerNode;10;-821.899,-418.4282;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;7130c16fd8005b546b111d341310a9a4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;24;-1706.73,260.3722;Inherit;False;Constant;_Vector0;Vector 0;6;0;Create;True;0;0;0;False;0;False;1,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.PannerNode;19;-1436.216,240.8032;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;20;-1713.637,129.1444;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SinTimeNode;16;-1351.88,479.0675;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-1544.422,416.9246;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1168.154,708.6942;Inherit;False;Property;_FireIntensity;FireIntensity;5;0;Create;True;0;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-1146.099,237.2134;Inherit;True;Property;_TileableFire;TileableFire;4;0;Create;True;0;0;0;False;0;False;-1;None;f7e96904e8667e1439548f0f86389447;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-823.1183,-206.3172;Inherit;True;Property;_WoodNormal;WoodNormal;1;0;Create;True;0;0;0;False;0;False;-1;None;11f03d9db1a617e40b7ece71f0a84f6f;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TimeNode;25;-1787.309,395.0532;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-591.8188,105.7993;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-1842.563,555.059;Inherit;False;Property;_FireSpeed;FireSpeed;6;0;Create;True;0;0;0;False;0;False;1;1;1;25;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;17;-1091.244,461.2175;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0.5;False;4;FLOAT;2.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;13;-457.2524,392.715;Inherit;True;Property;_WoodSpecular;WoodSpecular;2;0;Create;True;0;0;0;False;0;False;-1;None;6618005f6bafebf40b3d09f498401fba;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;14;-1145.252,12.86328;Inherit;True;Property;_Mask;Mask;3;0;Create;True;0;0;0;False;0;False;-1;None;36be8d528a4fa024faa4680d7658642c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=7E86B6CB99079CAA92384FC3FFF91E507CBA2D4E